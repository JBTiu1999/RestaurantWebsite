...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="../index.php">
                <img src="../images/logo.png" alt="cs" height="150" width="250"> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="../functions/login.php" method="POST">
                ...
                <div class="form-actions">
                  ...
                  <div class="create-account">
                    <p>
                        <a href="signup.php" id="register-btn" class="uppercase">Create an account</a>
                    </p>
                </div>
        ...
        <div class="copyright"> 2020 © Catering Service</div>
        <!--[if lt IE 9]>
