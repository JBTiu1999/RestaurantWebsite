                            ...
                            <a href="reservation.php" class="nav-link nav-toggle">
                                ...
                                <span class="selected"></span>
                                  <?php
                                    ...
                                    $result=mysqli_query($con,"SELECT count(*) as total from tbl_reservation where status != 'Cancelled'");
                            ...
                            <a href="client.php" class="nav-link nav-toggle">
                                ...
                                <span class="selected"></span>
                                 <?php
                                    ...
                                    $result=mysqli_query($con,"SELECT count(*) as total from tbl_register");
                                    $data=mysqli_fetch_assoc($result);
                                    $percent = $data['total'];
                        ...
                        <li class="sidebar-search-wrapper">
                            ...
                            <a href="reservation.php" class="nav-link nav-toggle">
                                ...
                                <?php
                                    ...
                                    $result=mysqli_query($con,"SELECT count(*) as total from tbl_reservation as reservation join tbl_user as users on reservation.reg_Id=users.reg_Id where users.user_Id='$user_Id' group by reservation.occasion");
                                    $data=mysqli_fetch_assoc($result);
                                    $percent = $data['total'];
                            ...
                            <a href="notification.php" class="nav-link nav-toggle">
                                ...
                                <span class="selected"></span>
                                 ...
                                 <?php
                                    include '../functions/connect.php';
                                    $user_Id = $_SESSION['sess_user_id'];
                                    $result=mysqli_query($con,"SELECT count(*) as total from tbl_notification as notification join tbl_register as register on notification.reg_Id=register.reg_Id join tbl_user as users on register.reg_Id=users.reg_Id where users.user_Id='$user_Id'");
                                    $data=mysqli_fetch_assoc($result);
                                    $percent = $data['total'];
